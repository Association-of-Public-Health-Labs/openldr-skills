...
```
GET /hiv/vl/summary/header_indicators/?interval_dates=2024-01-01,2024-12-31
...
|-----------|------|--------|----------|---------|-------------|-------------|
| `interval_dates` | string | `YYYY-MM-DD,YYYY-MM-DD` | YES (recommended) | Last 12 months | No | Start and end dates in one comma-separated value |
...
`interval_dates` is an exception to the normal multi-value convention. Pass
the date range as one comma-separated value:

```
# Correct date range
?interval_dates=2024-01-01,2024-12-31

# Wrong date range; may cause "list index out of range"
?interval_dates=2024-01-01&interval_dates=2024-12-31

# Other multi-value filters still use repeated keys
